...
import homehub_handler


class BtdemoDriver (ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        resource = Btdemo.create_from_context(context)

        #ssh to device to get info
        hh_instance = homehub_handler.abcd()
        mydata = hh_instance.get_data(resource.user, resource.password)
        resource.my_property
    ...
    def refresh(self, context):
        ...
        :param CancellationContext cancellation_context: Object to signal a request for cancellation. Must be enabled in drivermetadata.xml as well
        """
        a = context.reservation.reservation_id

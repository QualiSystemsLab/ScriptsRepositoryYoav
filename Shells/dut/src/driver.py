...
class DutDriver (ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        resource = Dut.create_from_context(context)
        number_of_ports = int(resource.num_of_ports)
        for i in range(1, number_of_ports+1):
            port = ResourcePort('Port {}'.format(str(i)))
            resource.add_sub_resource('{}'.format(str(i)), port)

...
class Ixvm(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Ixvm'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Ixvm
        """
        result = Ixvm(name=context.resource.name)
    ...
    def license_server(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.license_server'] if 'Ixvm.license_server' in self.attributes else None
    ...
    def license_server(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixvm.license_server'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.User'] if 'Ixvm.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixvm.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ixvm.Password'] if 'Ixvm.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ixvm.Password'] = value
    ...
    def public_ip(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.Public IP'] if 'Ixvm.Public IP' in self.attributes else None
    ...
    def public_ip(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixvm.Public IP'] = value
...
class GenericVPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Ixvm.GenericVPort'
        self._name = name
    ...
    def requested_vnic_name(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.GenericVPort.Requested vNIC Name'] if 'Ixvm.GenericVPort.Requested vNIC Name' in self.attributes else None

    @requested_vnic_name.setter
    def requested_vnic_name(self, value):
        """
        VNic to be associated with the vPort.
        :type value: str
        """
        self.attributes['Ixvm.GenericVPort.Requested vNIC Name'] = value
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.GenericVPort.MAC Address'] if 'Ixvm.GenericVPort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixvm.GenericVPort.MAC Address'] = value
    ...
    def ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ixvm.GenericVPort.IP Address'] if 'Ixvm.GenericVPort.IP Address' in self.attributes else None
    ...
    def ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Ixvm.GenericVPort.IP Address'] = value

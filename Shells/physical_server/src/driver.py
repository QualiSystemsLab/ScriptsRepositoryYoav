...
class PhysicalServerDriver (ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        resource = PhysicalServer.create_from_context(context)
        for i in range(1,5):
            port = ResourcePort('Port {}'.format(i))
            resource.add_sub_resource('{}'.format(i), port)

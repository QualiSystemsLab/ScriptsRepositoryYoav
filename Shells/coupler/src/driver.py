...
class CouplerDriver (ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        resource = Coupler.create_from_context(context)
        port1 = ResourcePort('Capture Port')
        resource.add_sub_resource('1', port1)
        portA = ResourcePort('Port A')
        resource.add_sub_resource('2', portA)
        portB = ResourcePort('Port B')
        resource.add_sub_resource('3', portB)

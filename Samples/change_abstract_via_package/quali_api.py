...
class QualiAPISession():
    ...
    def ImportPackage(self, package_filepath):
        """
    ...
    def ExportPackage(self, blueprint_full_names, target_filename):
        """
    ...
    def AddShell(self, shell_filename):
        """
    ...
    def UpdateShell(self, shell_name, shell_filename):
        """
    ...
    def GetInstalledStandards(self):
	    """
